...
public class EventFileController {
    ...
    @ResponseBody
    public List<EventFileVO> uploadAjaxAction(MultipartFile[] uploadFiles){
        log.info("upload ajax action...........");
        List<EventFileVO> fileList = new ArrayList<>();

        String uploadFolder = "C:/upload/event";
...
//        replace()를 사용한다.
    ...
    public ResponseEntity<byte[]> getFile(String fileName){
        File file = new File("C:/upload/event" + fileName);
        log.info("file : " + file);
    ...
    public ResponseEntity<Resource> downloadFile(String fileName){
        ...
        Resource resource = new FileSystemResource("C:/upload/event" + fileName);
