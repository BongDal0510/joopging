...
var naver_id_login = function (client_id,redirect_uri)
{
    ...
    this.getNaverIdLoginLink = function ()
    {
        ...
        if ( ( this.redirect_uri == undefined ) || ( this.redirect_uri == "�깅줉�� Callback URL 媛�" ) || ( this.redirect_uri.length < 5 ) )
        {
            ...
            console.log("uri 주소 : " + redirect_uri);
            return false;
        }
    ...
    this.init_naver_id_login = function ()
    {
        ...
        {
            console.log("글씨 깨져서 뭔지 1도 모르겟다 : " + "id 媛� naver_id_login �� div tag 媛� 議댁옱�댁빞 �⑸땲��.");
            return false;
        }
        ...
        if (this.popup)
        {
            ...
            naver_id_popup_option = " onClick=\"location.href=(this.href, 'naverloginpop');\" ";
        }
    ...
    this.get_naver_userprofile = function(callback_func1) {
        $.ajax({
            ...
            success: function (result) {
                ...
                //alert("네이버 로그인 토큰 : " + naver_id_login.oauthParams.access_token);
